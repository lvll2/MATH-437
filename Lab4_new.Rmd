...
Answer: In the plots of both our x variables, lstat and age, against medv we see clear trends which inclines us to say the relationship between our prediction and response variables are not linear. There may be some signs of colinearity as well, as the relationship between our variables lstat and age have a correlation value of .6 so it is not too bad.
