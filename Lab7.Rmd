...
Sensitivity = 12787/13449  `r round(12787/13449, 3)`

Specificity = 4206/9249 `r round(4206/9249, 3)`

Positive Predictive Value = 12787/17830 `r round(12787/17830, 3)`

Negative Predictive Value = 4206/4868 `r round(4206/4868, 3)`
...
Sensitivity = 13377/13449 = `r round(13377/13449, 3)`

Specificity = 2541/9249 = `r round(2541/9249, 3)`

Positive Predictive Value = 13377/20085 = `r round(13377/20085, 3)`

Negative Predictive Value = 2541/2613 = `r round(2541/2613, 3)`
...
Sensitivity = 12801/13449 = `r round(12801/13449, 3)`

Specificity = 4327/9249 = `r round(4327/9249, 3)`

Positive Predictive Value = 12801/17723 = `r round(12801/17723, 3)`

Negative Predictive Value = 4327/4975 = `r round(4327/4975, 3)`
...
If we can reasonably assume that our predictors are independent, I would use the Naive Bayes model since it is performing almost as well as the QDA model and is less computationally demanding. If we could not make this assumption, or we were working with small data, I would use the QDA model.
