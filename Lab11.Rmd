...
Using this matrix, we perform max pooling by choosing the maximum value in each non-overlapping 2x2 submatrix. For example, for the 2x2 submatrix [9 9;7 0] the maximum value is 9 which is the first entry in our final matrix. 
