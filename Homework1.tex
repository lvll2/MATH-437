...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{nG }\OtherTok{\textless{}{-}} \DecValTok{10}
\NormalTok{d }\OtherTok{\textless{}{-}} \FloatTok{0.8}
\ControlFlowTok{for}\NormalTok{ (i }\ControlFlowTok{in} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(pvalues))\{}
  \FunctionTok{set.seed}\NormalTok{(i)  }\CommentTok{\# notice that the seed changes every time inside the for loop}
  \CommentTok{\# you could also set a single seed outside the for loop}
  
  \CommentTok{\# Create the vectors x and y}
\NormalTok{  x }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(nG}\SpecialCharTok{*}\FloatTok{0.9}\NormalTok{, }\AttributeTok{mean =} \DecValTok{0}\NormalTok{, }\AttributeTok{sd =} \FunctionTok{sqrt}\NormalTok{(}\FloatTok{0.19}\NormalTok{)),}
         \FunctionTok{rnorm}\NormalTok{(nG}\SpecialCharTok{*}\FloatTok{0.1}\NormalTok{, }\AttributeTok{mean =} \DecValTok{3}\NormalTok{, }\AttributeTok{sd =} \FunctionTok{sqrt}\NormalTok{(}\FloatTok{0.19}\NormalTok{))}
\NormalTok{)}
\NormalTok{  y }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}\FunctionTok{rnorm}\NormalTok{(nG}\SpecialCharTok{*}\FloatTok{0.9}\NormalTok{, }\AttributeTok{mean =}\NormalTok{ d, }\AttributeTok{sd =} \FunctionTok{sqrt}\NormalTok{(}\FloatTok{0.19}\NormalTok{)),}
         \FunctionTok{rnorm}\NormalTok{(nG}\SpecialCharTok{*}\FloatTok{0.1}\NormalTok{, }\AttributeTok{mean =} \DecValTok{3} \SpecialCharTok{+}\NormalTok{ d, }\AttributeTok{sd =} \FunctionTok{sqrt}\NormalTok{(}\FloatTok{0.19}\NormalTok{))}
\NormalTok{)}

  \CommentTok{\# Perform the t{-}test and get the p{-}value}
\NormalTok{  pvalues[i] }\OtherTok{\textless{}{-}} \FunctionTok{t.test}\NormalTok{(x, y, }\AttributeTok{alternative =} \StringTok{"t"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{p.value}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# histogram of the p{-}values under H0}
\FunctionTok{hist}\NormalTok{(pvalues)}

\FunctionTok{plot}\NormalTok{(}\FunctionTok{ecdf}\NormalTok{(pvalues),}
     \AttributeTok{xlab =} \StringTok{"p{-}value"}\NormalTok{,}
     \AttributeTok{ylab =} \StringTok{"F(p{-}value)"}\NormalTok{,}
     \AttributeTok{main =} \StringTok{"Empirical CDF of the P{-}Value Under H0"}\NormalTok{)}

\FunctionTok{mean}\NormalTok{(pvalues }\SpecialCharTok{\textless{}=} \FloatTok{0.05}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{)}
  ...
  \CommentTok{\# Perform the t{-}test and get the p{-}value}
\NormalTok{  pvalues[i] }\OtherTok{\textless{}{-}} \FunctionTok{wilcox.test}\NormalTok{(x, y, }\AttributeTok{alternative =} \StringTok{"t"}\NormalTok{)}\SpecialCharTok{$}\NormalTok{p.value}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{\# Elite \textless{}{-} rep ("No", nrow (college))}
\CommentTok{\# Elite[college$Top10perc \textgreater{} 50] \textless{}{-} "Yes "}
\CommentTok{\# Elite \textless{}{-} as.factor (Elite)}
\CommentTok{\# college \textless{}{-} data.frame (college , Elite)}

\NormalTok{College }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{mutate}\NormalTok{(}\AttributeTok{Elite =} \FunctionTok{case\_when}\NormalTok{(Top10perc }\SpecialCharTok{\textgreater{}} \DecValTok{50} \SpecialCharTok{\textasciitilde{}}\StringTok{"Yes"}\NormalTok{,Top10perc}\SpecialCharTok{\textless{}=} \DecValTok{50} \SpecialCharTok{\textasciitilde{}} \StringTok{"No"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
