...
```{r ggplot associates}
ggplot(data = associates, aes(x = overall, y = difficulty)) +
  ...
  ggtitle("Bruh, these teachers ugly")
...
The difficulty of a professor does not seem to be too dependent on attractiveness but their overall rating definitely seems to show less attractive teachers getting overall lower scores whereas attractive teachers tend to be on the higher end of overall rating.
