...
```{r}
D = matrix(data = c(mean(iris_sv_s$Sepal.Length) - mean(iris_sv_v$Sepal.Length),
                    mean(iris_sv_s$Sepal.Width) - mean(iris_sv_v$Sepal.Width),
                    mean(iris_sv_s$Petal.Length) - mean(iris_sv_v$Petal.Length),
                    mean(iris_sv_s$Petal.Width) - mean(iris_sv_v$Petal.Width)))
...
```
$ Discriminant \space Function = Sepal.Length*1 + Sepal.Width * 5.9038 - Petal.Length*7.1299 -Petal.Width*10.1037  $
