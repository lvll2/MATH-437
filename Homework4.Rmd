...
In order to classify a new iris flower we would calculate its' discriminat and if that value is less than 0 
we would predict it to be veriscolor and if that value were greater than 0 it would be classified as setosa. (I am assuming that the descision boundary is zero but I am not 100% positive)
