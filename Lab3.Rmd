...
It is not appropriate to do a one-way ANOVA test with this data because our data is made up of repeated measures (the monthly excess returns) for each variable (the managers) therefore the samples are not independent.
