...
SFA from literature was not significant but was chosen in our model removing what we expected to be significant, ACC.
...
```
BIC had 12 significant variables and cp had 15 variables. Both BIC and cp had all 10 variables that previous literature mentioned but BIC also included SFA and PBK and cp also included SFA, CTH, SPC, RLS, PBK
